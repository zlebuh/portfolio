var translations = {
  cs: {
    ...
    "projects.solverBenchmark.type": "Živé demo",
    "projects.solverBenchmark.title": "Solver Benchmark",
    "projects.solverBenchmark.desc": "Databáze, API a GUI pro benchmarking optimalizačních solverů. Umožňuje sledovat různé verze solverů a porovnávat řešení instancí v čase.",
    "projects.minTacToe.type": "Open Source",
    "projects.minTacToe.title": "Min Tac Toe",
    "projects.minTacToe.desc": "Malá multiplayerová hra piškvorky, vytvořená pro experimentování s real-time hratelností a minimalistickým UI.",
    "projects.tradingBenchmark.type": "Soukromý projekt",
    "projects.tradingBenchmark.title": "Trading Agent Benchmark",
    "projects.tradingBenchmark.desc": "Nástroj pro benchmarking historických dat obchodního agenta na Polymarketu, vytvořený jako analýza business plánu pro malý tým.",
    "projects.creditSystem.type": "V provozu",
    "projects.creditSystem.title": "Credit System",
    "projects.creditSystem.desc": "Systém pro správu kreditů pro malé týmy a organizace, aktuálně v provozu.",

    // Experience
    "exp.label": "// Práce a studium v chronologickém pořadí.",
    "exp.title": "Životopis",
