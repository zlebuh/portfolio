---
title: Quiz Engine
description: Engine pro self-hosted kvíz. Hostitel a zároveň moderátor kvízu řídí hru z jedné společné obrazovky. Hráči se připojují přes QR kód a odpovídají ze svých mobilů.
