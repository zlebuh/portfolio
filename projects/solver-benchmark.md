---
title: Solver Benchmark - obecný dashboard pro optimalizaci
description: Všechny optimalizační problémy nebo velké kombinatorické úlohy mají jedno společné. Mají jasně definované datové typy pro vstup a výstup. Přesně s tímto počítá tato webová aplikace. Je možné ji snadno přepoužít pro libovolný problém. Umožňuje spouštět různé solvery na různé instance a ukládat a porovnávat vypočtená řešení. Veřejně dostupné demo obsahuje ukázky Vehicle Routing Problem a jejich řešení.
